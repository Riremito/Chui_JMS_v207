...
public class HiredMerchantHandler {
    ...
    public static final void MerchantItemStore(final InPacket inPacket, final MapleClient c) {
        if (c.getPlayer() == null) {
            return;
        }
        ...
        if (operation == 20 && !GameConstants.GMS) {
            ...
            c.write(PlayerShopPacket.merchItemStore((byte) (GameConstants.GMS ? 0x25 : 0x24)));
            ...
            if (!check(c.getPlayer(), pack)) {
                c.write(PlayerShopPacket.merchItem_Message((byte) (GameConstants.GMS ? 0x23 : 0x21)));
                return;
            }
            if (deletePackage(c.getPlayer().getAccountID(), pack.getPackageid(), c.getPlayer().getId())) {
                c.getPlayer().gainMeso(pack.getMesos(), false);
                ...
                c.write(PlayerShopPacket.merchItem_Message((byte) (GameConstants.GMS ? 0x1F : 0x1D)));
            } else {
                c.getPlayer().dropMessage(1, "An unknown error occured.");
            }
