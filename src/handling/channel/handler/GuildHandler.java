...
/*        for (int i = 0; i < name.length(); i++) {
    ...
    public static final void Guild(final InPacket inPacket, final MapleClient c) {
        ...
        switch (inPacket.decodeByte()) { //AFTERSHOCK: most are +1
		...
		World.Guild.gainGP(c.getPlayer().getGuildId(), 500, c.getPlayer().getId());
            ...
            case 0x0f: // Rank change
                cid = inPacket.decodeInt();
                byte newRank = inPacket.decodeByte();
            ...
            case 0x10: // guild emblem change
                ...
                final short bg = inPacket.decodeShort();
                final byte bgcolor = inPacket.decodeByte();
                final short logo = inPacket.decodeShort();
                final byte logocolor = inPacket.decodeByte();
            ...
            case 0x1d: //guild skill purchase
                Skill skilli = SkillFactory.getSkill(inPacket.decodeInt());
            ...
            case 0x1e: //guild skill activation
                skilli = SkillFactory.getSkill(inPacket.decodeInt());
