...
public class MapleGuild implements java.io.Serializable {
    ...
    public final void addMemberData(final OutPacket outPacket) {
        ...
        for (final MapleGuildCharacter mgc : members) {
            ...
            outPacket.encodeInt(mgc.getJobId()); //-1 = ??
            outPacket.encodeInt(mgc.getLevel()); //-1 = ??
            outPacket.encodeInt(mgc.getGuildRank());
            outPacket.encodeInt(mgc.isOnline() ? 1 : 0);
            outPacket.encodeInt(mgc.getAllianceRank());
            outPacket.encodeInt(mgc.getGuildContribution());
        }
    }
