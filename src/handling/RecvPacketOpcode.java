...
public enum RecvPacketOpcode implements WritableIntValueHolder {
    ...
    private final static Map<Short, RecvPacketOpcode> opToHeaderMap = new HashMap<>();
    static {
        for (RecvPacketOpcode ih : values()) {
    ...
    public static RecvPacketOpcode getHeaderByOp(int op) {
