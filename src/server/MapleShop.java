...
//	rechargeableItems.add(2330006); // Beginner Bullet
    ...
    public void sendShop(MapleClient c) {
        ...
        c.write(MaplePacketCreator.getNPCShop(getNpcId(), this, c));
    }

    public void sendShop(MapleClient c, int customNpc) {
        c.getPlayer().setShop(this);
        c.write(MaplePacketCreator.getNPCShop(customNpc, this, c));
    }
        ...
        if (index >= 0) {
            ...
            if (price >= 0 && c.getPlayer().getMeso() >= price) {
                if (MapleInventoryManipulator.checkSpace(c, itemId, i.getQuantity(), i.getOwner())) {
                    ...
                    c.write(MaplePacketCreator.confirmShopTransaction((byte) 0, this, c, x));
                } else {
                    c.getPlayer().dropMessage(1, "Your inventory is full.");
                    c.write(MaplePacketCreator.confirmShopTransaction((byte) 0, this, c, -1));
                }
            } else {
                c.write(MaplePacketCreator.confirmShopTransaction((byte) 0, this, c, -1));
            }
    ...
    public void sell(MapleClient c, MapleInventoryType type, byte slot, short quantity) {
        ...
        if (quantity <= iQuant && iQuant > 0) {
            if (!GameConstants.GMS) { // JUMP 之後才有
            ...
            c.write(MaplePacketCreator.confirmShopTransaction((byte) 5/*0x4*/, this, c, -1));
        }
    }
    ...
    public void recharge(final MapleClient c, final byte slot) {
        ...
        if (item.getQuantity() < slotMax) {
            ...
            if (c.getPlayer().getMeso() >= price) {
                ...
                c.write(MaplePacketCreator.updateInventorySlot(MapleInventoryType.USE, (Item) item, false));
                c.getPlayer().gainMeso(-price, false, false);
                c.write(MaplePacketCreator.confirmShopTransaction((byte) 9/*0x8*/, this, c, -1));
            }
        }
    }
