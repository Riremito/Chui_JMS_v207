    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case killing_BonusSetting: { //spawns monsters according to mapid
                ...
                c.getPlayer().getMap().resetFully();
                c.write(MaplePacketCreator.showEffect("killing/bonus/bonus"));
                c.write(MaplePacketCreator.showEffect("killing/bonus/stage"));
            ...
            case shammos_Fenter: {
                if (c.getPlayer().getMapId() >= (GameConstants.GMS ? 921120100 : 921120005) && c.getPlayer().getMapId() < (GameConstants.GMS ? 921120300 : 921120500)) {
                    ...
                    c.write(MaplePacketCreator.getNodeProperties(shammos, c.getPlayer().getMap()));
    ...
    public static void startScript_User(final MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case cannon_tuto_direction1: {
                ...
                c.write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/0", 5000, 0, 0, 1));
                c.write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/1", 5000, 0, 0, 1));
                c.write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/2", 5000, 0, 0, 1));
                c.write(UIPacket.ShowWZEffect("Effect/Direction4.img/cannonshooter/face04"));
                c.write(UIPacket.ShowWZEffect("Effect/Direction4.img/cannonshooter/out01"));
                c.write(UIPacket.getDirectionInfo(1, 5000));
                break;
            }
            ...
            case PRaid_W_Enter: {
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_expPenalty", "0"));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_ElapssedTimeAtField", "0"));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_Point", "-1"));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_Bonus", "-1"));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_Total", "-1"));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_Team", ""));
                c.write(MaplePacketCreator.sendPyramidEnergy("PRaid_IsRevive", "0"));
            ...
            case q31103s:
                ...
                break;
            case Resi_tutor20:
                c.write(UIPacket.MapEff("resistance/tutorialGuide"));
                break;
            case Resi_tutor30:
                c.write(UIPacket.AranTutInstructionalBalloon("Effect/OnUserEff.img/guideEffect/resistanceTutorial/userTalk"));
                break;
            case Resi_tutor40:
                NPCScriptManager.getInstance().dispose(c);
                c.removeClickedNPC();
            ...
            case merTutorSleep02: {
                c.write(UIPacket.IntroEnableUI(0));
                break;
            }
            ...
            case merTutorDrecotion10: {
                ...
                c.write(UIPacket.IntroEnableUI(1));
                c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/6", 2000, 0, -100, 1));
            ...
            case merTutorDrecotion20: {
                c.write(UIPacket.getDirectionStatus(true));
                c.write(UIPacket.IntroEnableUI(1));
                c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/9", 2000, 0, -100, 1));
                c.write(UIPacket.getDirectionInfo(1, 2000));
                c.getPlayer().setDirection(0);
                break;
            }
            ...
            case mPark_stageEff:
                ...
                switch ((c.getPlayer().getMapId() % 1000) / 100) {
                    ...
                    case 2:
                    case 3:
                        c.write(UIPacket.MapEff("monsterPark/stageEff/stage"));
                        c.write(UIPacket.MapEff("monsterPark/stageEff/number/" + (((c.getPlayer().getMapId() % 1000) / 100) + 1)));
                        break;
                    case 4:
                        if (c.getPlayer().getMapId() / 1000000 == 952) {
                            c.write(UIPacket.MapEff("monsterPark/stageEff/final"));
                        } else {
                            c.write(UIPacket.MapEff("monsterPark/stageEff/stage"));
                            c.write(UIPacket.MapEff("monsterPark/stageEff/number/5"));
                        }
                        break;
                    case 5:
                        c.write(UIPacket.MapEff("monsterPark/stageEff/final"));
            ...
            case TD_MC_title: {
                ...
                c.write(UIPacket.IntroLock(false));
                c.write(MaplePacketCreator.enableActions());
                c.write(UIPacket.MapEff("temaD/enter/mushCatle"));
                break;
            }
            case TD_NC_title: {
                switch ((c.getPlayer().getMapId() / 100) % 10) {
                    case 0:
                        c.write(UIPacket.MapEff("temaD/enter/teraForest"));
                        break;
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 5:
                    case 6:
                        c.write(UIPacket.MapEff("temaD/enter/neoCity" + ((c.getPlayer().getMapId() / 100) % 10)));
                        break;
                }
                break;
            }
...
//                        c.getPlayer().dropMessage(-1, "勲章 " + String.valueOf(m) + " 探険家 currently in progress");
                        c.write(MaplePacketCreator.showQuestMsg("勲章 - " + String.valueOf(m) + "探険家挑戦中。" + number + "/" + m.maps.length + " 完了"));
                    }
                }
                break;
            }
            ...
            case ds_tuto_ill0: {
                c.write(UIPacket.getDirectionInfo(1, 6300));
            ...
            case ds_tuto_home_before: {
                c.write(UIPacket.getDirectionInfo(3, 1));
                c.write(UIPacket.getDirectionInfo(1, 30));
                c.write(UIPacket.getDirectionStatus(true));
                c.write(UIPacket.getDirectionInfo(3, 0));
                c.write(UIPacket.getDirectionInfo(1, 90));

                c.write(MaplePacketCreator.showEffect("demonSlayer/text11"));
                c.write(UIPacket.getDirectionInfo(1, 4000));
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_4_0: {
                ...
                c.write(UIPacket.getDirectionStatus(true));
                c.write(UIPacket.getDirectionInfo(3, 0));
                c.write(UIPacket.getDirectionInfo(4, 2159344));
            ...
            case cannon_tuto_01: {
                ...
                c.write(UIPacket.getDirectionInfo(3, 0));
                c.write(UIPacket.getDirectionInfo(4, 1096000));
                NPCScriptManager.getInstance().dispose(c);
            ...
            case ds_tuto_5_0: {
                ...
                c.write(UIPacket.getDirectionStatus(true));
                c.write(UIPacket.getDirectionInfo(3, 0));
                c.write(UIPacket.getDirectionInfo(4, 2159314));
                NPCScriptManager.getInstance().dispose(c);
            ...
            case ds_tuto_3_0: {
                ...
                c.write(UIPacket.getDirectionInfo(1, 30));
                c.write(UIPacket.getDirectionStatus(true));
                c.write(MaplePacketCreator.showEffect("demonSlayer/text12"));

                EventTimer.getInstance().schedule(new Runnable() {

                    public void run() {
                        c.write(UIPacket.getDirectionInfo(3, 0));
                        c.write(UIPacket.getDirectionInfo(4, 2159311));
                        NPCScriptManager.getInstance().dispose(c);
            ...
            case ds_tuto_3_1: {
                ...
                c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg2/0", 2000, 0, -100, 1));
                c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg1/3", 2000, 0, -100, 1));
                EventTimer.getInstance().schedule(new Runnable() {

                    public void run() {
                        c.write(UIPacket.getDirectionInfo(3, 0));
                        c.write(UIPacket.getDirectionInfo(4, 2159340));
                        NPCScriptManager.getInstance().dispose(c);
            ...
            case ds_tuto_2_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.write(UIPacket.getDirectionInfo(3, 0));
                        c.write(MaplePacketCreator.showEffect("demonSlayer/text13"));
                        c.write(UIPacket.getDirectionInfo(1, 500));
                    }
                }, 1000);
                EventTimer.getInstance().schedule(new Runnable() {

                    public void run() {
                        c.write(MaplePacketCreator.showEffect("demonSlayer/text14"));
                        c.write(UIPacket.getDirectionInfo(1, 4000));
                    }
                }, 1500);
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_1_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.write(UIPacket.getDirectionInfo(3, 0));
                        c.write(MaplePacketCreator.showEffect("demonSlayer/text8"));
                        c.write(UIPacket.getDirectionInfo(1, 500));
                    }
                }, 1000);
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.write(MaplePacketCreator.showEffect("demonSlayer/text9"));
                        c.write(UIPacket.getDirectionInfo(1, 3000));
                    }
                }, 1500);
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_0_0: {
                ...
                c.write(UIPacket.getDirectionInfo(3, 0));
                c.write(MaplePacketCreator.showEffect("demonSlayer/back"));
                c.write(MaplePacketCreator.showEffect("demonSlayer/text0"));
                c.write(UIPacket.getDirectionInfo(1, 500));
                c.getPlayer().setDirection(0);
            ...
            case Massacre_result: { //clear, give exp, etc.
                //if (c.getPlayer().getPyramidSubway() == null) {
                c.write(MaplePacketCreator.showEffect("killing/fail"));
                //} else {
                //	c.write(MaplePacketCreator.showEffect("killing/clear"));
                //}
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        ...
        c.write(MaplePacketCreator.trembleEffect(0, 1));
    }
    ...
    public static void startDirectionInfo(MapleCharacter chr, boolean start) {
        ...
        if (di != null && di.eventQ.size() > 0) {
            if (start) {
                c.write(UIPacket.IntroDisableUI(true));
                c.write(UIPacket.getDirectionInfo(3, 4));
            } else {
                for (String s : di.eventQ) {
                    switch (directionInfo.fromString(s)) {
                        case merTutorDrecotion01: //direction info: 1 is probably the time
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/0", 2000, 0, -100, 1));
                            break;
                        case merTutorDrecotion02:
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/1", 2000, 0, -100, 1));
                            break;
                        case merTutorDrecotion03:
                            c.write(UIPacket.getDirectionInfo(3, 2));
                            c.write(UIPacket.getDirectionStatus(true));
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/2", 2000, 0, -100, 1));
                            break;
                        case merTutorDrecotion04:
                            c.write(UIPacket.getDirectionInfo(3, 2));
                            c.write(UIPacket.getDirectionStatus(true));
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/3", 2000, 0, -100, 1));
                            break;
                        case merTutorDrecotion05:
                            c.write(UIPacket.getDirectionInfo(3, 2));
                            c.write(UIPacket.getDirectionStatus(true));
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/4", 2000, 0, -100, 1));
                            EventTimer.getInstance().schedule(new Runnable() {

                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(3, 2));
                                    c.write(UIPacket.getDirectionStatus(true));
                                    c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/5", 2000, 0, -100, 1));
                                }
                            }, 2000);
                            EventTimer.getInstance().schedule(new Runnable() {
                        ...
                        case merTutorDrecotion12:
                            c.write(UIPacket.getDirectionInfo(3, 2));
                            c.write(UIPacket.getDirectionStatus(true));
                            c.write(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/8", 2000, 0, -100, 1));
                            c.write(UIPacket.IntroEnableUI(0));
                            break;
                        case merTutorDrecotion21:
                            ...
                            break;
                        case ds_tuto_0_2:
                            c.write(MaplePacketCreator.showEffect("demonSlayer/text1"));
                            break;
                        case ds_tuto_0_1:
                            c.write(UIPacket.getDirectionInfo(3, 2));
                            break;
                        case ds_tuto_0_3:
                            c.write(MaplePacketCreator.showEffect("demonSlayer/text2"));
                            EventTimer.getInstance().schedule(new Runnable() {

                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(1, 4000));
                                    c.write(MaplePacketCreator.showEffect("demonSlayer/text3"));
                                }
                            }, 2000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(1, 500));
                                    c.write(MaplePacketCreator.showEffect("demonSlayer/text4"));
                                }
                            }, 6000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(1, 4000));
                                    c.write(MaplePacketCreator.showEffect("demonSlayer/text5"));
                                }
                            }, 6500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(1, 500));
                                    c.write(MaplePacketCreator.showEffect("demonSlayer/text6"));
                                }
                            }, 10500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(1, 4000));
                                    c.write(MaplePacketCreator.showEffect("demonSlayer/text7"));
                                }
                            }, 11000);
                            EventTimer.getInstance().schedule(new Runnable() {

                                public void run() {
                                    c.write(UIPacket.getDirectionInfo(4, 2159307));
                                    NPCScriptManager.getInstance().dispose(c);
