...
public class MapleExtractor extends MapleMapObject {
    ...
    public void sendSpawnData(MapleClient client) {
        client.write(MaplePacketCreator.makeExtractor(owner, ownerName, getTruePosition(), getTimeLeft(), itemId, fee));
    }

    @Override
    public void sendDestroyData(MapleClient client) {
        client.write(MaplePacketCreator.removeExtractor(this.owner));
    }
