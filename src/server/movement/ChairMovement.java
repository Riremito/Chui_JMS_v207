...
public class ChairMovement extends AbstractLifeMovement {
    ...
    public ChairMovement(int type, Point position, int duration, int newstate, MovementKind kind) {
    ...
    public void serialize(OutPacket outPacket) {
        ...
        outPacket.encodeShort(getPosition().x);
        outPacket.encodeShort(getPosition().y);
