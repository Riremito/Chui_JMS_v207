...
import connection.netty.NettyClient;
...
//    private transient IoSession session;
    ...
    public MapleClient(io.netty.channel.Channel channel, byte[] sendSeq, byte[] recvSeq) {
...
/*    public void write(byte[] data) {
    ...
    public final byte getLoginState() { // TODO hide?
        ...
        try {
            ...
            if (state == MapleClient.LOGIN_SERVER_TRANSITION || state == MapleClient.CHANGE_CHANNEL) {
                if (rs.getTimestamp("lastlogin").getTime() + 20000 < System.currentTimeMillis()) { // connecting to chanserver timeout 20秒
                    
                    final List<MapleCharacter> chars = loadCharacters(0);
    ...
    public final String getSessionIPAddress() {
        return ch.remoteAddress().toString().split(":")[0];
    }
    ...
    public final void DebugMessage(final StringBuilder sb) {
        ...
        sb.append("Connected: ");
        sb.append(ch.isActive());
        sb.append(" Closing: ");
        sb.append(ch.isOpen());
        sb.append(" ClientKeySet: ");
        sb.append(ch.attr(CLIENT_KEY) != null);
        sb.append(" loggedin: ");
