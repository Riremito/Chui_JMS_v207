...
public enum MonsterStatus implements Serializable, Buffstat {
    ...
    MAGIC_CRASH(0x10, 2),
    //speshul comes after
    EMPTY(0x8000000, 1, false/*true*/),
    SUMMON(0x80000000, 1, false/*true*/), //all summon bag mobs have.
    EMPTY_1(0x20, 2, false/*!GameConstants.GMS*/), //chaos
    EMPTY_2(0x40, 2, false/*true*/),
    EMPTY_3(0x80, 2, false/*true*/),
    EMPTY_4(0x100, 2, false/*GameConstants.GMS*/), //jump
    EMPTY_5(0x200, 2, false/*GameConstants.GMS*/),
    EMPTY_6(0x400, 2, false/*GameConstants.GMS*/),;
