...
/*        switch (mapId) {
    ...
    public static void achievementRatio(MapleClient c) {
        ...
        switch (c.getPlayer().getMapId()) {
            ...
            case 923040100:
            case 921160100:
                c.write(MaplePacketCreator.achievementRatio(0));
                break;
            case 930000200:
            case 922010200:
            case 922010300:
            ...
            case 926110001:
            case 921160200:
                c.write(MaplePacketCreator.achievementRatio(10));
                break;
            case 930000300:
            case 910340200:
            case 922010500:
            ...
            case 921160340:
            case 921160350:
                c.write(MaplePacketCreator.achievementRatio(25));
                break;
            case 930000400:
            case 926100200:
            case 926110200:
            ...
            case 926110202:
            case 921160400:
                c.write(MaplePacketCreator.achievementRatio(35));
                break;
            case 910340300:
            case 922010700:
            case 930000500:
            ...
            case 923040300:
            case 921160500:
                c.write(MaplePacketCreator.achievementRatio(50));
                break;
            case 910340400:
            case 922010800:
            case 930000600:
            ...
            case 923040400:
            case 921160600:
                c.write(MaplePacketCreator.achievementRatio(70));
                break;
            case 910340500:
            case 922010900:
            case 930000700:
            ...
            case 921120400:
            case 921160700:
                c.write(MaplePacketCreator.achievementRatio(85));
                break;
            case 922011000:
            case 922011100:
            case 930000800:
            ...
            case 921120500:
            case 921120600:
                c.write(MaplePacketCreator.achievementRatio(100));
                break;
        }
    }
    ...
    public static int getMaxHP_PVP(short job, int pvplevel, boolean bIceKnight) {
        if (bIceKnight) return (pvplevel >= 2 ? 95000 : pvplevel < 1 ? 50000 : 72000);

        switch (job / 10) {
            case 11: return (pvplevel >= 2 ? 18000 : pvplevel < 1 ? 10000 : 14000);
            case 12: return (pvplevel >= 2 ? 20000 : pvplevel < 1 ? 10000 : 15000);
            case 13: return (pvplevel >= 2 ? 20000 : pvplevel < 1 ? 10000 : 13500);

            case 21, 22, 23: return (pvplevel >= 2 ? 10000 : pvplevel < 1 ? 5000 : 7500);

            case 31, 32, 41, 52: return (pvplevel >= 2 ? 13000 : pvplevel < 1 ? 7500 : 10000);

            case 42: return (pvplevel >= 2 ? 15000 : pvplevel < 1 ? 8000 : 12500);
            case 43: return (pvplevel >= 2 ? 13500 : pvplevel < 1 ? 6000 : 10000);

            case 51: return (pvplevel >= 2 ? 16500 : pvplevel < 1 ? 10000 : 15000);

            case 53: return (pvplevel >= 2 ? 13500 : pvplevel < 1 ? 8000 : 11000);
        }

        switch (job / 100) {
            case 11: return (pvplevel >= 2 ? 20000 : pvplevel < 1 ? 9000 : 13500);
            case 12: return (pvplevel >= 2 ? 11000 : pvplevel < 1 ? 4500 : 7000);
            case 13: return (pvplevel >= 2 ? 13500 : pvplevel < 1 ? 7000 : 9500);
            case 14: return (pvplevel >= 2 ? 13500 : pvplevel < 1 ? 7000 : 10000);
            case 15: return (pvplevel >= 2 ? 15000 : pvplevel < 1 ? 9000 : 11500);

            case 21: return (pvplevel >= 2 ? 16000 : pvplevel < 1 ? 9000 : 13000);
            case 22: return (pvplevel >= 2 ? 10000 : pvplevel < 1 ? 6000 : 8000);
            case 23: return (pvplevel >= 2 ? 12500 : pvplevel < 1 ? 7000 : 9500);

            case 31: return (pvplevel >= 2 ? 16500 : pvplevel < 1 ? 8500 : 13500);
            case 32: return (pvplevel >= 2 ? 13500 : pvplevel < 1 ? 8000 : 11000);
            case 33, 35: return (pvplevel >= 2 ? 11500 : pvplevel < 1 ? 6000 : 9000);
        }
