...
//    public static final byte[] Gateway_IP = (GameConstants.GMS ? (TESPIA ? new byte[]{(byte) 0x3F, (byte) 0xFB, (byte) 0xD9, (byte) 0x72} : new byte[]{(byte) 0x8, (byte) 0x1F, (byte) 0x62, (byte) 0x34}) : new byte[]{(byte) 0xCB, (byte) 0x74, (byte) 0xC4, (byte) 0x08}); //singapore
    ...
    // End of Poll
    public static final short MAPLE_VERSION = (short) 207;
    public static final String MAPLE_PATCH = "0";
    public static final byte MAPLE_LOCALE = 3;
    public static final Charset ASCII = Charset.forName("MS932");
    ...
    public static final String MASTER_LOGIN = "adminzb69", MASTER = "55$clr0CK15!", MASTER2 = "5701337570", SQL_USER = "root", SQL_PASSWORD = "";
