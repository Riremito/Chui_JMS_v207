...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void askMapSelection(final String sel) {
        ...
        c.write(MaplePacketCreator.getMapSelection(id, sel));
    ...
    public void sendNext(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 01", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendNextS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 01", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendPrev(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 00", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendPrevS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 00", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendNextPrev(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 01", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendNextPrevS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 01", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendOk(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 00", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendOkS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 00", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendYesNo(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 2, text, "", (byte) 0));
        lastMsg = 2;
    }
    ...
    public void sendYesNoS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 2, text, "", type, idd));
        lastMsg = 2;
    }
    ...
    public void askAcceptDecline(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) lastMsg, text, "", (byte) 0));
    }
    ...
    public void askAcceptDeclineNoESC(String text, int id) {
        ...
        lastMsg = (byte) (GameConstants.GMS ? 0xF : 0xE);
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) lastMsg, text, "", (byte) 1));
    }
    ...
    public void askAvatar(String text, int... args) {
        ...
        c.write(MaplePacketCreator.getNPCTalkStyle(id, text, args));
        lastMsg = 9;
    }
    ...
    public void sendSimple(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 5, text, "", (byte) 0));
        lastMsg = 5;
    }
    ...
    public void sendSimpleS(String text, byte type, int idd) {
        ...
        c.write(MaplePacketCreator.getNPCTalk(id, (byte) 5, text, "", (byte) type, idd));
        lastMsg = 5;
    }
    ...
    public void sendStyle(String text, int styles[]) {
        ...
        c.write(MaplePacketCreator.getNPCTalkStyle(id, text, styles));
        lastMsg = 9;
    }
    ...
    public void sendGetNumber(String text, int def, int min, int max) {
        ...
        c.write(MaplePacketCreator.getNPCTalkNum(id, text, def, min, max));
        lastMsg = 4;
    }
    ...
    public void sendGetText(String text, int id) {
        ...
        c.write(MaplePacketCreator.getNPCTalkText(id, text));
        lastMsg = 3;
    }
    ...
    public void displayGuildRanks() {
        c.write(MaplePacketCreator.showGuildRanks(id, MapleGuildRanking.getInstance().getRank()));
    }
    ...
    public void sendPVPWindow() {
        c.write(MaplePacketCreator.sendPVPWindow(0));
        c.write(MaplePacketCreator.sendPVPMaps());
    }

    public void sendRepairWindow() {
        c.write(MaplePacketCreator.sendRepairWindow(id));
    }

    public void sendProfessionWindow() {
        c.write(MaplePacketCreator.sendProfessionWindow(1/*0*/));
    }
    ...
    public final void sendRPS() {
        c.write(MaplePacketCreator.getRPSMode((byte) 8, -1, -1, -1));
    }
    ...
    public void putKey(int key, int type, int action) {
        ...
        getClient().write(MaplePacketCreator.getKeymap(getPlayer().getKeyLayout()));
    }
    ...
    public void sendUltimateExplorer() {
        getClient().write(MaplePacketCreator.ultimateExplorer());
    }
    ...
    public void sendPendant(boolean b) {
        c.write(MaplePacketCreator.pendantSlot(b));
    }
