...
CREATE TABLE `donorlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21408 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `drop_data` (
  ...
  PRIMARY KEY (`id`),
  KEY `mobid` (`dropperid`)
) ENGINE=MyISAM AUTO_INCREMENT=44988 DEFAULT CHARSET=utf8;
...
CREATE TABLE `pwreset` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17511 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=838 DEFAULT CHARSET=utf8 PACK_KEYS=1;
...
CREATE TABLE `shops` (
  ...
  PRIMARY KEY (`shopid`)
) ENGINE=MyISAM AUTO_INCREMENT=9595018 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
